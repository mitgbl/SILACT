...
str2 = 'C:\\Users\\Quadro\\MIT 3D Optics Group Dropbox\\Deep-learning_ODT\\Training_Dataset\\GT_high_freq_0.5\\'
path_1= r'C:\\Users\\Quadro\\MIT 3D Optics Group Dropbox\\Deep-learning_ODT\\Training_Dataset\\Inputs_3'
path_2= r'C:\\Users\\Quadro\\MIT 3D Optics Group Dropbox\\Deep-learning_ODT\\Training_Dataset\\GT_high_freq_0.5'
...
#    tr_out_item= tr_out_item['RI_high']
    with hp.File(output_path, 'r') as Outputs:
        tr_out_item = (Outputs['n_high'][()])
        tr_out_item = np.transpose(tr_out_item,(1,2,0))
...
#    test_out_item= test_out_item['RI_high']
    with hp.File(output_path, 'r') as Outputs:
        test_out_item = (Outputs['n_high'][()])
        test_out_item = np.transpose(test_out_item,(1,2,0))
...
G_4_1_c=Conv2D(50,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_4_1_relu)
G_4_c_bn=BatchNormalization()(G_4_1_c)
G_4_c_bn_relu= Activation('relu')(G_4_c_bn)
G_4_01=Conv2D(50,kernel_size=(3,3),strides=(1,1), padding='same')(G_4_c_bn_relu)
G_4_02=Conv2D(50,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_3_out)
G_4_0_out=Add()([G_4_01,G_4_02])

G_4r_bn=BatchNormalization()(G_4_0_out)
G_4r_relu=Activation('relu')(G_4r_bn)
G_4r_c=Conv2D(50,kernel_size=(3,3),strides=(1,1), padding='same')(G_4r_relu)
G_4r_c_bn=BatchNormalization()(G_4r_c)
G_4r_c_bn_relu=Activation('relu')(G_4r_c_bn)
G_4r_c_out=Conv2D(50,(3,3),strides=(1,1),padding='same')(G_4r_c_bn_relu)
...
G_5_1_c=Conv2D(80,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_5_1_relu)
G_5_c_bn=BatchNormalization()(G_5_1_c)
G_5_c_bn_relu= Activation('relu')(G_5_c_bn)
G_5_01=Conv2D(80,kernel_size=(3,3),strides=(1,1), activation='relu', padding='same')(G_5_c_bn_relu)
G_5_02=Conv2D(80,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_4_out)
G_5_0_out=Add()([G_5_01,G_5_02])

G_5r_bn=BatchNormalization()(G_5_0_out)
G_5r_relu=Activation('relu')(G_5r_bn)
G_5r_c=Conv2D(80,kernel_size=(3,3),strides=(1,1), padding='same')(G_5r_relu)
G_5r_c_bn=BatchNormalization()(G_5r_c)
G_5r_c_bn_relu=Activation('relu')(G_5r_c_bn)
G_5r_c_out=Conv2D(80,(3,3),strides=(1,1),padding='same')(G_5r_c_bn_relu)
...
G_6_up_c_1_out=Conv2D(128,kernel_size=(3,3),strides=(1,1), padding='same')(G_6_up_ct_relu)
G_6_up_c_2_out=Conv2DTranspose(128,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_5_out)
...
G_5_up_c_1_out=Conv2D(160,kernel_size=(3,3),strides=(1,1), padding='same')(G_5_up_ct_relu)
G_5_up_c_2_out=Conv2DTranspose(160,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_6_up_out)
...
G_4_up_ct= Conv2DTranspose(80, kernel_size=(3,3), strides=(2,2),padding='same')(G_4_up_relu)
G_4_up_ct_bn=BatchNormalization()(G_4_up_ct)
G_4_up_ct_relu= Activation('relu')(G_4_up_ct_bn)
G_4_up_c_1_out=Conv2D(150,kernel_size=(3,3),strides=(1,1), padding='same')(G_4_up_ct_relu)
G_4_up_c_2_out=Conv2DTranspose(150,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_5_up_out)
...
G_3_up_ct= Conv2DTranspose(75, kernel_size=(3,3), strides=(2,2),padding='same')(G_3_up_relu)
G_3_up_ct_bn=BatchNormalization()(G_3_up_ct)
G_3_up_ct_relu= Activation('relu')(G_3_up_ct_bn)
G_3_up_c_1_out=Conv2D(128,kernel_size=(3,3),strides=(1,1), padding='same')(G_3_up_ct_relu)
G_3_up_c_2_out=Conv2DTranspose(128,kernel_size=(3,3),strides=(2,2), activation='relu', padding='same')(G_4_up_out)
...
G_2_up_ct= Conv2DTranspose(64, kernel_size=(3,3), strides=(2,2),padding='same')(G_2_up_relu)
...
G.fit(tr_in,tr_out,batch_size=5,epochs=500,verbose=1,validation_split=0.05)
# ##
# train_loss=G_history.history['loss']
# validation_loss=G_history.history['val_loss']
G.save('model_3t3_4angles_crudephase2tomo_high_spectral_model_version2.h5')
rec=G.predict(test_in,batch_size=5,verbose=1)
sio.savemat('rec_3t3_4angles_crudephase2tomo_high_spectral_model_version2.mat',mdict={'rec':rec})
#sio.savemat('test_out_3t3_spectral_01.mat',mdict={'test_out':test_out})
# plt.plot(train_loss)
